...
//        File f = new File(ExtractCertificatesTest.class.getResource("/").getPath());
//        System.out.println(f);
        String property = System.getProperty("user.dir");
        System.out.println(property );
        File file=new File("D:\\down\\browser\\MyFxUtil\\MyFxUtil\\MySpringUtil\\target\\classes\\cn\\i623\\myspringutil\\fun");
